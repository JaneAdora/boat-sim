...
export const JOURNAL_ENTRIES: Record<string, string> = {
  ...
  'stolen-ship': 'Sailed off in a stolen ship',
  pirate: 'Turned pirate — fenced hot cargo',
  treasure: 'Dug up buried treasure',
  leviathan: 'Watched the Leviathan take a ship',
